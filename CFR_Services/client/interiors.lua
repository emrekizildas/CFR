...
function recieveServicesInteriorMarkers( x,y,z,marker_type,i,d )
	...
	if (markers[num].MType ~= nil) then
		markers[num].Blip = createBlipAttachedTo(markers[num].Col, markers[num].MType, 1, 0, 0, 0, 255, 0, 500)
	end
	...
	onClientColShapeHit(markers[num].Col, true)
