...
function buyShopArticle( shopID, articleID )
	...
	if( getPlayerMoney( source ) < shops[shopID].Articles[articleID].Price ) then
		outputChatBox("* Maalesef " .. shops[shopID].Articles[articleID].Name .. " alacak paran yok!", source, 255, 255, 0 )
		return
	end
	...
	-- give it
	outputChatBox("* "..getPlayerNametagText(source).." "..shops[shopID].Articles[articleID].Price.." lira ile "..shops[shopID].Articles[articleID].Name .. " Satýn alýr. ", source, 255, 122, 61)
